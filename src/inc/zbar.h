...
/**
 * reduce image size to half height and half width
 * buffer is gray image, each byte represent one pixel
 */
extern zbar_image_t* zbar_image_downsize(const zbar_image_t *src);
